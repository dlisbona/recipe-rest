...
import com.projectRecipe.model.RecipeIngredient;
...
public class RecipeIngredientDto {
     ...
     RecipeIngredientDto(RecipeIngredient recipeIngredient) {
          this.id = recipeIngredient
               .getId();
          this.ingredient = new IngredientDto(recipeIngredient
               .getIngredient());
          this.quantity = recipeIngredient
               .getQuantity();
          this.unit = recipeIngredient
               .getUnit();
     }
