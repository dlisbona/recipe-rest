package com.projectRecipe.controllers;
...
import com.projectRecipe.services.IngredientService;
...
public class IngredientController {
     ...
     public ResponseEntity<IngredientDto> getById(@PathVariable("id") final Long id) {
          Optional<IngredientDto> ingredientDto = ingredientService
               .getById(id);
     ...
     public ResponseEntity create(@RequestBody final String name) {
          Optional<Long> ingredientId = ingredientService
               .create(name);
     ...
     public ResponseEntity<Ingredient> update(@RequestBody IngredientDto ingredientDto) {
          Optional<Ingredient> ingredient = ingredientService
